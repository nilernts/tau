...
export default function Vault(): JSX.Element {
    ...
    const balance = useFCLLendAmounts(fcl.account)
    console.debug("Lend balance:", balance)
        ...
        return [
            {
                id: "0",
                symbol: "DCT",
                liquidity: balance?.amount ?? "0.0",
                deposits: balance?.amount ?? "0.0",
    ...
    }, [balance, tokenBalances, tokenBalances?.length, tokenBalances?.[0], tokenBalances?.[1]])

    console.debug("Vault:", vaults)
                        ...
                        <div className={`col-span-12`}>
                            <Card className="bg-dark-900 z-4">
                                <div className={`grid grid-cols-12 md:space-x-4 space-y-4 md:space-y-0 `}>
                                        ...
                                        <div className={`hidden md:block`}>
                                            <div className={`col-span-12 md:col-span-4 bg-dark-800 px-6 py-4 rounded`}>
                                                ...
                                                <div className="mb-4 text-base text-secondary">
                                                    <p>
                                                        {`The Tau Lending Vault is a set of high incentivized lending pools. Users can choose to lend their assets
                                                          for high rewards.`}
                                                    </p>
                                                    <p className="mt-2">
                                                        {/* {`In exchange for their lent assets, lenders receive interest-bearing tokens which they may use to mint taUSD,
                                                          an innovative, auto-farming stablecoin on Tau.`} */}
                                                        &nbsp; <br />
                                                        &nbsp; <br />
                                                        &nbsp; <br />
                                                        &nbsp; <br />
                                    ...
                                    >
                                        <VaultList markets={data} fcl={fcl} />
                                    </div>
                                </div>
                            </Card>
                        </div>
