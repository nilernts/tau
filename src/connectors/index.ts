...
export const network = new NetworkConnector({
    defaultChainId: Number(ChainId.XDC_APOTHEM),
    urls: RPC,
})
...
export const bloctosdk = new BloctoConnector({
    chainId: Number(ChainId.MATIC_TESTNET),
    rpc: "https://rpc-mumbai.maticvigil.com/",
})

export const injected = new InjectedConnector({
    supportedChainIds: [ChainId.MATIC_TESTNET, ChainId.XDC_APOTHEM, ChainId.MOONRIVER].map(Number),
})
