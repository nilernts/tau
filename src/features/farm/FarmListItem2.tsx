                        ...
                        >
                            <div className="grid grid-cols-4 ">
                                <div className="flex col-span-2 space-x-4 md:col-span-1">
                                    ...
                                    <div className={`flex flex-col justify-center ${token1 ? "md:flex-row" : ""}`}>
                                        <div>
                                            ...
                                            {token1 && (
                                                <span className="flex font-bold">{farm?.pair?.token1?.symbol}</span>
                                            )}
                                            {!token1 && token0?.symbol == "TAU" && (
                                                <div className="flex flex-col">
                                                    <span className="text-emphasis underline hover:text-yellow">
                                                        Unstake
                                                    </span>
                                                    <Link href="/vaults">
                                                        <span className="text-emphasis underline hover:text-yellow">
                                ...
                                <div className="flex flex-col justify-center font-bold">
                                    {formatNumberScale(tvl, true, 2)}
                                </div>
                                <div className="flex-row items-center hidden space-x-4 md:flex">
                                    <div className="flex items-center space-x-2">
                                        {farm?.rewards?.map((reward, i) => (
                                            <div key={i} className="flex rounded items-center">
                                                <Image
                                                    src={`https://i.ibb.co/1vSJkcK/tau.png`}
                                                    width="50px"
                                                    height="50px"
                                    ...
                                    <div className="flex flex-col space-y-1">
                                        {farm?.rewards?.map((reward, i) => (
                                            <div key={i} className="text-xs md:text-sm whitespace-nowrap">
                                                ...
                                                {/* {formatNumber(50.3)} {reward.token} / DAY */}
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                <div className="flex flex-col items-end justify-center">
                                    ...
                                    >
                                        ...
                                        {formatPercent(farm?.roiPerYear * 10000 || 75)}
