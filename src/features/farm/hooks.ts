...
export function useChefContract(chef: Chef) {
    const solarDistributorContract = useTauDistributorContract()
...
export function usePositions() {
    return useSolarPositions(useTauDistributorContract())
}
...
export function useFarms() {
    return useTauFarms(useTauDistributorContract())
}
