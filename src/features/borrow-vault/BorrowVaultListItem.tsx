...
import BorrowVaultListItemDetails from "./BorrowVaultListItemDetails"
...
const BorrowLendVaultListItem = ({ market, fcl, ...rest }) => {
            ...
            <Disclosure {...rest}>
                {({ open }) => (
                    <div className="mb-4">
                            ...
                            <div className="grid grid-cols-5 ">
                                <div className="flex col-span-2 space-x-4 lg:col-span-1">
                                    ...
                                    <div className={`flex flex-col justify-center md:flex-row`}>
                                        <div>
                                            <span className="flex font-bold">{market?.symbol}</span>
                                            {/* {token1 && (
                                ...
                                <div className="flex flex-col justify-center font-bold">
                                    {formatNumberScale(market.balance, true, 2)}
                                </div>
                                ...
                                {/* Borrow Balance APY */}
                                <div className="flex flex-col justify-center font-bold">
                                    {formatNumberScale(market.borrows, true, 2)}

                                    {/* <div className="font-bold flex items-center">
                                        { formatNumberScale(market.lendBalanceWithInterest, true, 2) }
                                    </div>
                                    <div className="text-xs md:text-base text-secondary">{`annualized`}</div> */}
                                </div>
                        ...
                        {open && <BorrowVaultListItemDetails farm={market} fcl={fcl} />}
                    </div>
                )}
            </Disclosure>
        </React.Fragment>
...
export default BorrowLendVaultListItem
