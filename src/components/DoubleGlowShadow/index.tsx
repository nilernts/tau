    ...
    return (
        <div className={`force-gpu relative w-full ${maxWidth ? "max-w-2xl" : ""}`}>
            <div
                ...
                className="absolute top-1/4 -left-1 bg-light-green bottom-4 w-3/5 rounded-full z-0 hidden sm:block"
            />
            <div
                style={{
                    filter: `blur(150px) opacity(${opacity})`,
                }}
                className="absolute bottom-1/4 -right-1 bg-green top-4 w-3/5 rounded-full z-0 hidden sm:block"
            />
