                ...
                {!hideInput && (
                    <div
                        className={classNames(
                            ...
                            // showMaxButton && currencyBalance && 'px-3'
                        )}
                    >
                        <>
                            ...
                            {!hideBalance && currency && currencyBalance ? (
                                <div className="flex flex-col">
                                    ...
                                    >
                                        {/* {renderBalance ? (
                                            renderBalance(currencyBalance as any)
                                        ) : ( */}
                                        <>
                                            {`Balance:`} {formatNumberScale(currencyBalance)} {currency.symbol}
                                        </>
                                        {/* )} */}
                                    </div>
