...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
    ...
    [ChainId.XDC_APOTHEM]: [WNATIVE[ChainId.XDC_APOTHEM]],
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
    ...
    [ChainId.XDC_APOTHEM]: [...WRAPPED_NATIVE_ONLY[ChainId.XDC_APOTHEM]],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
    ...
    [ChainId.OKEX]: [...WRAPPED_NATIVE_ONLY[ChainId.OKEX], OKEX.DAI, OKEX.USDC, OKEX.USDT, OKEX.WBTC, OKEX.WETH],
    [ChainId.XDC_APOTHEM]: [
        ...WRAPPED_NATIVE_ONLY[ChainId.XDC_APOTHEM],
        XDC_APOTHEM.DCT,
        XDC_APOTHEM.MAV,
        XDC_APOTHEM.WLR,
        XDC_APOTHEM.DIB,
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
    ...
    [ChainId.XDC_APOTHEM]: deployments.swap.TauFactory,
    [ChainId.XDC_MAINNET]: "",
}
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
    ...
    [ChainId.XDC_APOTHEM]: deployments.swap.TauRouter02,
    [ChainId.XDC_MAINNET]: "",
}
