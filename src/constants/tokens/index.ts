...
export const XDC_APOTHEM: { [key: string]: Token } = {
    wXDC: new Token(ChainId.XDC_APOTHEM, getDeployedAddresses().tokens.wXDC, 18, "wXDC", "Wrapped XDC"),
    TAU: new Token(ChainId.XDC_APOTHEM, getDeployedAddresses().tokens.TAU, 18, "TAU", "TAU Token"),
    DCT: new Token(ChainId.XDC_APOTHEM, getDeployedAddresses().tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.XDC_APOTHEM, getDeployedAddresses().tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.XDC_APOTHEM, getDeployedAddresses().tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.XDC_APOTHEM, getDeployedAddresses().tokens.DIB, 18, "DIB", "Dib Token"),
}
...
export const SOLAR_ADDRESS = {
    ...
    [ChainId.XDC_APOTHEM]: deployments.tokens.TAU,
}

export const SOLAR: ChainTokenMap = {
    [ChainId.XDC_APOTHEM]: new Token(ChainId.XDC_APOTHEM, SOLAR_ADDRESS[ChainId.XDC_APOTHEM], 18, "TAU", "Tau Token"),
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
    ...
    [SupportedChainId.XDC_APOTHEM]: new Token(ChainId.XDC_APOTHEM, deployments.tokens.wXDC, 18, "wXDC", "XDC"),
}
